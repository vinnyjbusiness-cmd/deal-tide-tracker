...
export default function LiverpoolPage() {
  ...
  const exportCSV = () => {
    ...
    a.href = url; a.download = "liverpool-sales.csv"; a.click();
  };
  ...
  return (
    <div className="p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Liverpool FC</h1>
